<template>
 <div class="card" v-if="item">
   <div class="card__container">
     ...
     <img v-if="getItemWeather().main === 'Clear'" src="http://openweathermap.org/img/wn/01d@2x.png" alt="clear sky">
     ...
     <p class="card__description">Temp <b>{{ temperatureOnCelsius(item.list[0].main.temp) }}°C</b></p>
     <p class="card__description">Feels like <b>{{ temperatureOnCelsius(item.list[0].main.feels_like) }}°C</b></p>
